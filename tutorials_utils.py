...
def initiate_db(project_name):
    ...
    db_utils.add_sites(db_initial_info["temp_sites_csv"], project_name, db_path)
    
    # Populate the movies info
    db_utils.add_movies(db_initial_info["temp_movies_csv"], project_name, db_path)
    
    # Populate the species info
    db_utils.add_species(db_initial_info["temp_species_csv"], project_name, db_path)
